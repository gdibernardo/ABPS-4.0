...
int main(int argc, char ** argv)
{
    ...
    for(index = 0; index < 100; index++)
    {
        ...
        json_object *message_content = json_object_new_string("hello from client app!hello from client app!hello from client app!hello from client app!hello from client app!hello from client app!hello from client app!hello from client app!hello from client app!hello from client app!hello from client app!hello from client app!hello from client app!hello from client app!hello from client app!hello from client app!hello from client app!hello from client app!hello from client app!hello from client app!hello from client app!hello from client app!");
