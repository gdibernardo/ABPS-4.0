...
\\
La funzione dev\_hard\_start\_xmit utilizzerà l'interfaccia esposta dalla struttura net\_device\_ops per cominciare la trasmissione in particolare invocherà la funzione ndo\_start\_xmit.
\\
...
\\
Verrà poi invocata la entry point \textbf{ieee80211\_xmit} del modulo mac80211 che tra le altre cose si occupa dell'inizializzazione del frame 802.11 e del suo header. Per far ciò il sottosistema mac80211 si serve di una serie di handler appositamente settati, tra cui: 
\begin{itemize}
