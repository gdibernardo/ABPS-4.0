...
\begin{chapter}{Il kernel Linux}
In questo capitolo verrà offerta una breve panoramica sul kernel Linux.
\\
Verrà inoltre descritto un aspetto del kernel Linux che risulta cruciale per lo sviluppo del progetto che questa tesi si propone di raccontare: i suoi moduli di rete.
\\
