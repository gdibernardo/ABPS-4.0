...
\begin{table}[h]
  ...
  I tempi presi in considerazione nella tabella~\ref{tab:AvgTimePkt} sono relativi solamente alle notifiche ricevute mentre tutti gli altri host trasmettevano dati.
...
\begin{subsection}{Valutazione interferenza traffico} %MENGO: altro titolo del cazzo
  ...
  Dai tempi in tabella~\ref{tab:AvgTimeMbs} si può notare come, in realtà, ci sia un ampio aumento del tempo medio di ricezione di una notifica al diminuire della velocità dell'altro host.
...
\begin{subsection}{Problemi dovuti alla trasmissione in movimento}
  ...
  Come ultimo, ma fondamentale, aspetto osserviamo il dato relativo ai NACK. 
  ...
  Come si può notare dal grafico !!!!!!!!!!!!!!!!!!!!!!!!!METTERE GRAFICO O TABELLA, e collegare meglio i due pezzi!!!!!!!!!!!!!!!!!!!!!!!!!!!!, si ha burst di NACK.
  Questo dato è molto importante in quanto se il client, durante un movimento, si mette in una condizione sfavorevole andando dietro ad un ostacolo la qualità della trasmissione peggiora sensibilmente.
  \\
