...
La disposizione tipica della rete è quella in figura RIFERIMENTO DELLA FIGURA!!!!!
In particolare, è stato usato il computer HP per svolgere la maggior parte dei test. 
Per creare del traffico in rete, invece, sono stati generalmente utilizzati il Raspberry Pi 2 e la UDOO, con l'eventuale aggiunta di altri dispositivi ( come altri portatili o tablet ).
\\
...
ATTENZIONE!!! I CAMPI DELLE TABELLE AL MOMENTO SONO ERRATI, PUÒ PERÒ ANDARE SE ANALIZZO IN QUESTO MODO I RISULTATI?
Andiamo ora ad analizzare i risultati ottenuti.
Per ogni parametro che vogliamo valutare andremo a valutare quanto può incidere nella trasmissione, lasciando inalterati tutti gli altri parametri.
...
In particolare si possono notare le medie dei tempi di IPv4 nella tabella ~\ref{tab:FirstTable} mentre quella di IPv6 nella tabella ~\ref{tab:FirstTableMuori}.
...
\hline
IPv4  & Da solo  & Un host a 70Mb/s  & Un host a 10Mb/s  & Un host a 6 Mb/s \\ \hline
...
\begin{table}[h]
\centering
\caption{Uso di IPv6: tempi}
\label{tab:FirstTableMuori}
\begin{tabular}{|l|c|c|c|c|}
\hline
IPv4  & Da solo  & Un host a 70Mb/s  & Un host a 10Mb/s  & Un host a 6 Mb/s \\ \hline
prima  & 0.4736  & 0.6684 & 1.1236 & 0.6174 \\ \hline
