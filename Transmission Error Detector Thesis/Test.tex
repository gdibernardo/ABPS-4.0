...
\end{figure}
  ...
  Per ogni configurazione viene mostrato il massimo numero di NACK consecutivi nel caso di trasmissione da fermo ( colore blu) e nel caso di trasmissione in movimento ( colore giallo ).
