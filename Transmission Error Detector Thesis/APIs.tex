...
\\
Tuttavia una qualsiasi applicazione, in esecuzione su di un kernel a cui è stato installato il modulo TED, può essere pensata e implementata per sfruttare il meccanismo di Transmission Error Detection raccontato in questo capitolo.
\\
