...
\\
L'utilizzo di queste funzioni è consigliato per una maggiore chiarezza e astrazione. Tutte le macro sono definite assieme alla struttura sock\_extended\_err nel file errqueue.h.
\\
...
Utilizzata per accedere all'identificativo del messaggio di cui la notifica è associata.
\\
\\
